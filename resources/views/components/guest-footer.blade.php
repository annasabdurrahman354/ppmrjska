<!-- ========== FOOTER ========== -->
<footer class="mt-auto w-full max-w-[85rem]  px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <!-- Grid -->
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        <div class="col-span-full hidden lg:col-span-1 lg:block">
            <a class="flex-none text-2xl font-semibold text-green-600 font-messiri dark:text-white" href="#" aria-label="Brand">PPM Roudlotul Jannah Surakarta</a>
            <p class="mt-3 text-xs sm:text-sm text-gray-600 dark:text-neutral-400">© 2024.</p>
        </div>
        <!-- End Col -->
        <div>
        ...
        <div>
            ...
            <div class="mt-3 grid space-y-3 text-sm">
                ...
                <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Careers</a> <span class="inline text-green-600 dark:text-green-500">— We're hiring</span></p>
        ...
        <div>
            ...
            <div class="mt-3 grid space-y-3 text-sm">
                ...
                <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Status</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">GitHub</a> <span class="inline text-green-600 dark:text-green-500">— New</span></p>
            </div>
        ...
        <div class="sm:flex sm:justify-between sm:items-center">
            <div class="flex items-center gap-x-3">
                ...
                <div class="space-x-4 text-sm">
                    <a class="inline-flex gap-x-2 font-messiri text-lg text-green-600 hover:text-green-400 dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Sarjana yang mubaligh. Mubaligh yang sarjana.</a>
                </div>
            </div>
            <div class="flex justify-between items-center">
                <div class="mt-3 sm:hidden">
                    <a class="flex-none text-xl font-semibold text-green-600 dark:text-white" href="#" aria-label="Brand">PPM Roudlotul Jannah</a>
