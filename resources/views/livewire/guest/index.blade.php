    ...
    <main id="content">
        <div class="overflow-hidden">
            ...
            <div class="relative">
                ...
                <!-- Hero -->
                <div class="relative">
                    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 md:py-10 lg:py-16">
                        <img class="absolute z-0 top-0 right-0 mt-10" src="https://static.shuffle.dev/components/preview/c6283f8f-6793-47ac-b2f0-908cc21b4d11/assets/public/saturn-assets/images/faq/star-right.svg" alt="" data-config-id="auto-img-2-2">
                        <!-- Grid -->
                        <div class="z-50 grid md:grid-cols-2 gap-12 md:gap-8 xl:gap-20 md:items-center">
                            <div class="relative ms-4">
                                <div class="w-full rounded-md">
                                    <video autoplay muted loop class="inset-0 rounded-3xl w-full h-auto object-cover">
                                        <source src="{{asset('index/Profil PPM.mp4')}}" type="video/mp4">
                                    </video>
                                </div>
                            </div>

                            <div>
                                <h1 class="block text-3xl font-bold font-messiri text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Selamat Datang di Situs Web <span class="text-green-600 font-serif italic">PPM Roudlotul Jannah Surakarta</span></h1>
                                <p class="mt-3 font-messiri text-lg text-gray-800 dark:text-neutral-400">Menjadi Sarjana Mubaligh, Profesional Religius.</p>
                    ...
                    <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
                        <div class="p-4 md:p-5">
                            <div class="flex items-center gap-x-2">
                                <p class="text-xs uppercase tracking-wide text-green-500 dark:text-neutral-500">
                                    Santri Aktif
                                </p>
                            </div>
        ...
        <!-- Slider -->
        <div wire:ignore class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
            <!-- Slider -->
                    ...
                    <div class="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
                        @forelse($carousels as $carousel)
                            <div class="hs-carousel-slide relative">
                                <div style="background-image: url('{{$carousel->getFirstMediaUrl('carousel_cover')}}')" class="h-[30rem] md:h-[calc(100vh-106px)] flex flex-col bg-cover bg-center bg-no-repeat before:absolute before:inset-x-0 before:bottom-0 before:z-[1] before:w-full before:h-1/3 before:bg-gradient-to-t before:from-green-700/70">
                                </div>
                                <div class="absolute bottom-0 inset-x-0 z-10 mt-auto w-2/3 md:max-w-lg ps-4 pb-4 md:ps-8 md:pb-8">
                                    <span class="w-fit rounded-xl line-clamp-2 lg:line-clamp-1 block text-white text-xl font-messiri font-medium md:text-2xl">{{$carousel->judul}}</span>
                                    @isset($carousel->link_tujuan)
                                        <div class="mt-2">
                                            <a href="//{{$carousel->link_tujuan}}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl bg-white border border-transparent text-black hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none">
                                                Baca Selengkapnya
                                            </a>
                                        </div>
                                    @endisset
                        ...
                        <!-- Item -->
                        <div class="hs-carousel-slide relative">
                            <div style="background-image: url('{{asset('index/dummy_carousel.png')}}')" class="h-[30rem] md:h-[calc(100vh-106px)] flex flex-col bg-cover bg-center bg-no-repeat before:absolute before:inset-x-0 before:bottom-0 before:z-[1] before:w-full before:h-1/3 before:bg-gradient-to-t before:from-green-700/70">
                            </div>
                            <div class="absolute bottom-0 inset-x-0 z-10 mt-auto w-2/3 md:max-w-lg ps-4 pb-4 md:ps-8 md:pb-8">
                                <span class="w-fit rounded-xl line-clamp-2 lg:line-clamp-1 block text-white text-xl font-messiri font-medium md:text-2xl">Lapangan PPM</span>
                                <div class="mt-2">
        ...
        <div class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
            ...
            <div class="max-w-2xl mx-auto text-center mb-8 lg:mb-10">
                <span class="inline-block py-1 px-3 mb-2 text-xs font-semibold text-green-900 bg-lime-50 rounded-full">PRAKATA</span>
                <h2 class="text-2xl font-bold font-serif italic md:text-4xl md:leading-tight dark:text-white">Kata Sambutan</h2>
            </div>
            <!-- End Title -->
            <!-- Grid -->
            <div class="lg:grid lg:grid-cols-6 lg:gap-8 lg:items-center">
                <div class="hidden lg:block lg:col-span-2">
                    <img class="rounded-xl" src="{{asset('index/Ketua PPM.png')}}" alt="Ketua PPM Roudlotul Jannah Surakarta">
                </div>
                <!-- End Col -->
                <div class="lg:col-span-4 px-8">
                    <!-- Blockquote -->
                    <blockquote class="w-full">
                        <img class="w-20 h-auto mb-4 hidden lg:block" src="{{asset('index/Logo PPM.png')}}" alt="Logo PPM Roudlotul Jannah Surakarta">
                        <p class="w-full lg:w-fit text-end lg:text-start text-2xl tracking-tighter font-diwany font-medium text-gray-800 lg:text-4xl lg:leading-normal dark:text-neutral-200">
                            السَّلاَمُ عَلَيْكُمْ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ
                        </p>
                        <p class="text-justify text-gray-800 lg:text-xl lg:leading-normal dark:text-neutral-200">
                            Selamat datang di website resmi Pondok Pesantren Mahasiswa Roudlotul Jannah Surakarta. Melalui platform ini, kami menyajikan informasi terkini tentang kegiatan dan proses pendidikan di pesantren kami. Selamat mengenal pesantren kami lebih jauh!
                        </p>
                        <footer class="mt-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4 lg:ms-0">
                                    <p class="font-messiri font-semibold text-lg text-gray-800 dark:text-neutral-200">
                                        Ust. Eko Prasetyo, S.Pd
                                    </p>
        ...
        <div class="max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
            ...
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <span class="inline-block py-1 px-3 mb-2 text-xs font-semibold text-green-900 bg-lime-50 rounded-full">PENGAJAR</span>
                <h2 class="text-2xl font-bold font-serif italic md:text-4xl md:leading-tight dark:text-white">Dewan Guru</h2>
            </div>
            <!-- End Title -->
                ...
                <div class="swiper-wrapper">
                    @forelse($dewan_gurus as $dewan_guru)
                        <div class="swiper-slide flex flex-col items-center justify-center text-center rounded-lg">
                            <div class="mx-auto bg-green-600 w-[148px] h-[148px] rounded-full flex items-center justify-center">
                                <img src="{{$dewan_guru->getFirstMediaUrl('dewan_guru_avatar')}}" alt="img" class="w-[140px] h-[140px] rounded-full object-cover border-4 border-white" draggable="false">
                            </div>
                            <h4 class="w-full mx-auto font-medium mt-3 mb-1">{{$dewan_guru->nama}}</h4>
                        </div>
                    @empty
                        @for($i = 0; $i < 7; $i++)
                            <div class="swiper-slide flex flex-col items-center justify-center text-center rounded-lg">
                                <div class="mx-auto bg-green-600 w-[148px] h-[148px] rounded-full flex items-center justify-center">
                                    <img src="{{asset('index/Ketua PPM.png')}}" alt="img" class="w-[140px] h-[140px] rounded-full object-cover border-4 border-white" draggable="false">
                                </div>
                                <h4 class="font-messiri font-semibold text-lg text-gray-800 dark:text-neutral-200 w-full mx-auto mt-3 mb-1">Ust. Eko Prasetyo, S.Pd.</h4>
                            </div>
                        @endfor
                    @endforelse
                </div>
        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <!-- Title -->
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <span class="inline-block py-1 px-3 mb-2 text-xs font-semibold text-green-900 bg-lime-50 rounded-full">INFORMASI MEDIA MASSA</span>
            ...
            <div class="pb-8 mx-auto">
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    @foreach($latest_blogs as $blog)
                        <!-- Card -->
                        <a class="group relative block rounded-xl" href="{{route('guest.blog.view', $blog->slug)}}">
                            <div class="flex-shrink-0 relative rounded-xl overflow-hidden w-full h-[350px] before:absolute before:inset-x-0 before:bottom-0 before:z-[1] before:w-full before:h-1/3 before:bg-gradient-to-t group-hover:before:from-green-700/70 before:from-green-900/70">
                                <img class="size-full absolute top-0 start-0 object-cover" src="{{$blog->getFirstMediaUrl('blog_cover')}}" alt="Image Description">
                            </div>
                                ...
                                <div class="p-4 flex flex-col h-full sm:p-6">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img class="size-[46px] border-2 border-white rounded-full" src="{{$blog->penulis->getAvatarUrl()}}" alt="Image Description">
                                        </div>
                            ...
                            <div class="absolute bottom-0 inset-x-0 z-10">
                                <div class="flex flex-col h-full p-4 sm:p-6">
                                    <h3 class="line-clamp-2 text-lg sm:text-3xl font-messiri font-semibold text-white group-hover:text-white/80">
                                        {{$blog->judul}}
                                    </h3>
                                    <p class="line-clamp-1 mt-2 text-white/80">
                                        {{$blog->deskripsi}}
                                    </p>
                                </div>
                            </div>
                        ...
                        <a class="group relative block rounded-xl" href="#">
                            ...
                            <div class="absolute bottom-0 inset-x-0 z-10">
                                <div class="flex flex-col h-full p-4 sm:p-6">
                                    ...
                                    <p class="line-clamp-1 mt-1 text-white/80">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($another_blogs as $blog)
                    <!-- Card -->
                    <a class="group hover:bg-gray-100 rounded-xl p-3 transition-all dark:hover:bg-white/10" href="{{route('guest.blog.view', $blog->slug)}}">
                        <div class="aspect-w-16 aspect-h-10">
                            <img class="w-full object-cover rounded-xl" src="{{$blog->getFirstMediaUrl('blog_cover')}}" alt="Image Description">
                        </div>
                        <h3 class="line-clamp-2 mt-3 text-xl font-semibold font-messiri  text-green-600 group-hover:text-green-500 dark:text-neutral-300 dark:group-hover:text-white">
                            {{$blog->judul}}
                        </h3>
                ...
                @empty
                    <!-- Card -->
                    <a class="group hover:bg-gray-100 border rounded-xl p-3 transition-all dark:hover:bg-white/10" href="#">
                        <div class="aspect-w-16 aspect-h-10">
        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <!-- Title -->
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <span class="inline-block py-1 px-3 mb-2 text-xs font-semibold text-green-900 bg-lime-50 rounded-full">PRNALA DARI LUAR</span>
                <h2 class="text-2xl font-bold font-serif italic md:text-4xl md:leading-tight dark:text-white">Media</h2>
            </div>
            <!-- End Title -->

            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @forelse($latest_medias as $media)
                    <!-- Card -->
                    <div id="media-button" wire:click="setClickedMedia(@js($media))" class="group border hover:bg-gray-100 rounded-xl p-2.5 transition-all dark:hover:bg-white/10 hover:cursor-pointer" data-hs-overlay="#hs-media-modal">
                ...
                @empty
                    <!-- Card -->
                    <div class="group border hover:bg-gray-100 rounded-xl p-2.5 transition-all dark:hover:bg-white/10 hover:cursor-pointer" data-hs-overlay="#hs-media-modal">
                        <div class="relative aspect-w-16 aspect-h-10">
        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <!-- Title -->
            <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                <span class="inline-block py-1 px-3 mb-2 text-xs font-semibold text-green-900 bg-lime-50 rounded-full">ALUMNI CORNER</span>
                <h2 class="text-2xl font-bold font-serif italic md:text-4xl md:leading-tight dark:text-white">Kata Alumni</h2>
            </div>
            <!-- End Title -->
            <!-- Testimonials -->
                        ...
                        <div class="flex flex-wrap -mx-4">
                            <div class="hs-accordion-group h-fit w-full lg:w-1/2 px-4 mb-6 lg:mb-0 grid grid-cols-1 gap-3">
                                    ...
                                    <div id="hs-basic-active-bordered-collapse-one" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-one">
                                        <div class="pb-4 px-5">
                                            <p class="text-gray-800 dark:text-neutral-200">
                                                Kegiatan KBM diadakan dua kali sehari pada hari Senin hingga Jumat (sesi subuh dan sesi malam) saat minggu masuk. Pada hari Sabtu dan Minggu terdapat tiga sesi (pagi, siang, dan malam). Pada minggu libur, KBM diadakan dua kali sehari, Senin hingga Jumat (sesi subuh dan sesi malam).
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transition-all duration-300 hs-accordion hs-accordion-active:bg-white/30 hs-accordion-active:backdrop-blur-sm hs-accordion-active:border-gray-200 border border-slate-200 rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-two">
                                    ...
                                    <div id="hs-basic-active-bordered-collapse-one" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-two">
                                        <div class="pb-4 px-5">
                                            <p class="text-gray-800 dark:text-neutral-200">
                                                Ya, diperbolehkan. Mahasiswa dapat membawa barang elektronik seperti HP dan laptop yang digunakan untuk kegiatan perkuliahan dan pondok. Barang elektronik lain seperti TV, radio, dan speaker tidak diperlukan.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transition-all duration-300 hs-accordion hs-accordion-active:bg-white/30 hs-accordion-active:backdrop-blur-sm hs-accordion-active:border-gray-200 border border-slate-200 rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-three">
                                    ...
                                    <div id="hs-basic-active-bordered-collapse-three" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-three">
                                        <div class="pb-4 px-5">
                                            <p class="text-gray-800 dark:text-neutral-200">
                                                Terdapat tiga jenis tes untuk calon santri baru: tes tertulis, tes bacaan, dan tes wawancara. Calon santri diharapkan mempersiapkan alat tulis dan mental dengan baik.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transition-all duration-300 hs-accordion hs-accordion-active:bg-white/30 hs-accordion-active:backdrop-blur-sm hs-accordion-active:border-gray-200 border border-slate-200 rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-four">
                                    ...
                                    <div id="hs-basic-active-bordered-collapse-three" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-four">
                                        <div class="pb-4 px-5">
                                            <p class="text-gray-800 dark:text-neutral-200">
                                                Tidak diperbolehkan membawa hewan peliharaan ke pondok. Hewan peliharaan harus ditinggalkan di rumah.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="hs-accordion-group h-fit w-full lg:w-1/2 px-4 mb-6 lg:mb-0 grid grid-cols-1 gap-3">
                                <div class="transition-all duration-300 hs-accordion hs-accordion-active:bg-white/30 hs-accordion-active:backdrop-blur-sm hs-accordion-active:border-gray-200 border border-slate-200 rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-one">
                                    ...
                                    <div id="hs-basic-active-bordered-collapse-one" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-one">
                                        <div class="pb-4 px-5">
                                            <p class="text-gray-800 dark:text-neutral-200">
                                                Ya, terdapat banyak kegiatan lainnya seperti Asrama Liburan, ASAD, Outing Sport, Hafalan Akbar, Erjes Talk, English Club, dll.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transition-all duration-300 hs-accordion hs-accordion-active:bg-white/30 hs-accordion-active:backdrop-blur-sm hs-accordion-active:border-gray-200 border border-slate-200 rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-two">
                                    ...
                                    <div id="hs-basic-active-bordered-collapse-one" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-two">
                                        <div class="pb-4 px-5">
                                            <p class="text-gray-800 dark:text-neutral-200">
                                                Kuota penerimaan santri disesuaikan dengan jumlah kamar yang tersedia.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transition-all duration-300 hs-accordion hs-accordion-active:bg-white/30 hs-accordion-active:backdrop-blur-sm hs-accordion-active:border-gray-200 border border-slate-200 rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-three">
                                    ...
                                    <div id="hs-basic-active-bordered-collapse-three" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-three">
                                        <div class="pb-4 px-5">
                                            <p class="text-gray-800 dark:text-neutral-200">
                                                Informasi terkait biaya akan dijelaskan lebih lanjut saat sosialisasi wali santri.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="transition-all duration-300 hs-accordion hs-accordion-active:bg-white/30 hs-accordion-active:backdrop-blur-sm hs-accordion-active:border-gray-200 border border-slate-200 rounded-xl dark:hs-accordion-active:border-neutral-700 dark:bg-neutral-800 dark:border-transparent" id="hs-active-bordered-heading-four">
                                    ...
                                    <div id="hs-basic-active-bordered-collapse-three" class="hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-active-bordered-heading-four">
                                        <div class="pb-4 px-5">
                                            <p class="text-gray-800 dark:text-neutral-200">
                                                Setiap kamar santri putra diisi oleh 2 orang. Kamar santri putri diisi oleh 2 hingga 3 orang. Penempatan kamar dan teman sekamar diatur oleh pengurus dan panitia
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
            <div class="w-full max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                    ...
                    <button id="close-btn" type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-neutral-700" data-hs-overlay="#hs-media-modal">
                ...
                <div class="p-4 overflow-y-auto">
                    <div class="space-y-4 w-full">
                        @if(isset($clickedMedia['embed']))
                            {!! html_entity_decode($clickedMedia['embed'])  !!}
                        @endif
                    </div>
                </div>
                <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-neutral-700">
                    @isset($clickedMedia['link_tujuan'])
                        <a href="//{{$clickedMedia['link_tujuan']}}" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-600 text-white hover:bg-green-700 disabled:opacity-50 disabled:pointer-events-none">
...
@push('scripts')
    <script>
        Livewire.on('media-tiktok-clicked', () => {
